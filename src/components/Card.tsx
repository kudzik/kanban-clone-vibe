      ...
      <div className="flex items-start justify-between">
        {isEditing ? (
          <textarea
            ...
            className="bg-transparent border-b-2 border-purple-500 text-sm font-medium text-white leading-tight focus:outline-none resize-none flex-1"
            autoFocus
            onKeyDown={(e) => {
          ...
          <h3 
            className="text-sm font-medium text-white leading-tight cursor-pointer hover:text-purple-300 transition-colors flex-1"
        ...
        {!isEditing && (
          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            <div className="relative">
              ...
              {showDeleteConfirm && (
                <div className="absolute right-0 top-6 bg-gray-800 border border-gray-600 rounded-lg p-2 shadow-lg z-10 min-w-40">
